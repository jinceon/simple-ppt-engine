...
public class ImageDataProcessor implements DataProcessor {
    ...
    public void process(XSLFShape shape, DataSource dataSource) {
        ...
        XSLFPictureData pictureData = shape.getSheet().getSlideShow().addPicture(picture, PictureData.PictureType.PNG);
        iPicture.setAnchor(new java.awt.Rectangle(360, 200, 280, 260));
